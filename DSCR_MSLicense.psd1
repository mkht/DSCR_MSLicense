#
# モジュール 'DSCR_MSLicense' のモジュール マニフェスト
#
# 生成者: mkht
#
# 生成日: 2016/11/15
...
GUID = 'ccb2e0b0-d59e-4f3e-b535-e2b4039014e8'
...
DscResourcesToExport = @('cWindowsLicense', 'cOfficeLicense')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = ('DesiredStateConfiguration','DSC','DSCResource', 'Windows', 'Office', 'License', 'Activation', 'KMS')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/mkht/DSCR_MSLicense/blob/master/LICENSE'

        # このプロジェクトのメイン Web サイトの URL。
        ProjectUri = 'https://github.com/mkht/DSCR_MSLicense'
